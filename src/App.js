...
function App() {
    const [uesrSelect, setUserSelect] = useState(null);
    ...
    return (
        <div>
            <div className="main">
                <Box title="You" item={uesrSelect} result={result} />
